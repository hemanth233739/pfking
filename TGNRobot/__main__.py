...
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ɪ ᴍ ᴠᴇʀʏ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ! ʜɪᴛ` /help
 [❤](https://telegra.ph/file/a4d36d8fea1e1a9c0e9c7.jpg)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴩꜰ ᴋɪɴɢ ᴛᴏ ᴜʀ ᴄʜᴀᴛ", url="t.me/TGN_Ro_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ꜱᴏᴜʀᴄᴇ 💫", url=f"https://github.com/pokechuff/pfking"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ ⚡", url=f"https://t.me/pfsupportff"
        ),
    ],
    [
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇꜱ ☑️", url=f"https://t.me/pf_family_ff"),
        InlineKeyboardButton(
            text="ᴍʏ ᴄʀᴇᴀᴛᴏʀ 🔥", url=f"https://t.me/POKECHU_FF"
        ),
    ],
    [
...
ᴀʟꜱᴏ ʏᴏᴜ ᴄᴀɴ ᴀꜱᴋ ᴀɴʏᴛʜɪɴɢ ɪɴ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ [❤️](https://telegra.ph/file/a4d36d8fea1e1a9c0e9c7.jpg)"""

START_IMG = "https://telegra.ph/file/eaab5fa7ac17bbc20c055.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [ᴍʏ ᴄʀᴇᴀᴛᴏʀ](t.me/POKECHU_FF) \
 Supporting isnt always financial! [ᴜᴩᴅᴀᴛᴇꜱ](https://t.me/eosupportff) \
